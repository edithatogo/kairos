...
| Normal-Form Multi-Game Runtime (Track 60) | R1 | Phase 0 is implemented locally: `StrategySpace`, `Utility`, `PayoffMatrix`, typed invariant errors, deterministic flattened payoff indexing, finite utility checks, and invalid-shape tests are in place. Solver systems, benchmarks, push, GitHub Actions review, and full runtime parity remain pending. |
