...
| Game Theory Ontology Wave Charter (Track 56) | R1 | Wave charter, evidence schema/templates, claim-boundary validator, and negative fixtures are checked in. The track remains In Progress until phase-closeout push, strict git closeout, and GitHub Actions evidence are fully reconciled. |
| Open Game Theory Ontology Ingestion (Track 57) | R2 | `open-game-theory-ontology/` exists with Turtle and JSON-LD fixtures, parser tests, canonical IR normalization, and review fixes. The track remains In Progress until final phase-closeout push, strict git closeout, and GitHub Actions evidence are fully reconciled. |
