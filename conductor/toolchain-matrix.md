...
|---|---:|---|---|---|---|---|---|---|---|---|---|
| Rust core | 00/01/13 | MSRV `1.76`; default channel `stable` | Rust `1.96.x` stable as of 2026-06-19 | Rust `beta` advisory lane | `stable`, `beta` | MSRV may rise only after 2 release cycles or 6 months notice; `stable` tracks upstream stable. | CI-covered | best-effort | best-effort | best-effort | best-effort |
