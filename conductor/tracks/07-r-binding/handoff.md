...
- `validate_conductor_git_closeout.ps1 -RequireCleanWorkingTree`: pending the closeout commit and push.
- next-phase decision: Track 07 is `In Review`; do not advance to `Done` until strict git closeout is possible.
