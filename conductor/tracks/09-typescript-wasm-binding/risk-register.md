...
| WASI Preview 2 spec instability | 3 | 3 | 9 | Pin specific WASI Preview 2 snapshot; test against that snapshot in CI; track upstream changes quarterly | typescript-agent | WASI snapshot used in CI breaks on wasmtime upgrade |
