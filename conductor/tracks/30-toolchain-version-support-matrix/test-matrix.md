...
| `pwsh -NoProfile -File conductor/tracks/30-toolchain-version-support-matrix/validate-toolchain-matrix.ps1 -CheckInstalled -Ecosystem rust -ExpectedPrefix 1.96` | Expected fail | Local default Rust reports 1.94 and local GNU stable reports 1.95; GitHub Actions is expected to install current Linux stable 1.96 for the matrix lane. |
