...
| SBOM attestation workflow verifies the full release artifact tree and uses the stable artifact upload action | `rg -n "RELEASE.txt|SHA256SUMS|release-artifact-manifest.json|actions/upload-artifact@v4" .github/workflows/sbom-attestations.yml` | no | yes | yes | yes |
