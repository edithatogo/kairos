...
- Task 1.1 pending commit: added the `codegen` feature, deterministic Rust generator, golden-regeneration tests, JSON-LD/Turtle equivalence tests, and invalid ontology contract tests.
...
- Generated helper types remain isolated behind the `codegen` feature until Track 58 Task 1.2 compiles them through `kairo-ecs-game-theory`.

## Follow-up issues

- Phase 1 Task 1.2: Compile generated components in `kairo-ecs-game-theory`.
...
- commit SHA: 14f3f4d, 2d49b07, 8486d90, 25201c5; Task 1.1 commit pending.
