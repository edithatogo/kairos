...
- [ ] Task 1.1: Add parser crate and failing tests for Turtle ingestion. Commit only after implementation passes as `track 57 task 1.1: parse turtle ontology fixtures`.
