...
| CLI interface not documented before first use | 4 | 4 | 16 | Publish `kairo-ecs-cli --help` output, man page, and quickstart before allowing usage to grow; keep `docs/cli/kairo-ecs-cli.md` aligned with the implemented smoke commands | experiment-agent | CLI ships without `--help` output or docs page matching implementation |
